...
export default function StudentRecords() {
  ...
  const fetchStudents = async () => {
    try {
      setLoading(true);
      const res = await api.get("/registrars/students/inactive");
  ...
  return (
      <div className="enrollment-container">
        ...
        <div className="header-actions">
          <button className="btn-print" onClick={fetchStudents}>
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan="15">
                  <div className="empty-state">
                    ...
                    <p>There are currently no inactive students.</p>
                  </div>
                </td>
              </tr>
            ) : (
              filteredStudents.map((student) => (
                ...
                <td data-label="Remark">{student.statusRemark || "-"}</td>
                 <td data-label="Issue">
  {student.statusIssueDate
    ? new Date(student.statusIssueDate).toLocaleDateString()
    : "-"}
</td>
                  <td data-label="Institute">
  {student.statusInstituteName || "-"}
</td>
